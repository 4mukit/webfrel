  ...
  return (
    <section
      className="flex flex-col items-center text-center relative mx-auto rounded-2xl overflow-hidden my-6 py-0 px-4
         w-full min-h-[380px] sm:min-h-[420px] md:w-[1220px] md:min-h-[600px] lg:min-h-[810px] md:px-0"
    >
      {/* SVG Background */}
      ...
      {/* Animated Shiny Gradient Overlay - Full Coverage */}
      <div className="absolute inset-0 z-5 rounded-2xl overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/8 via-primary/4 to-primary/12 animate-pulse"></div>
        <div
          className="absolute inset-0 bg-gradient-to-tr from-transparent via-primary/6 to-transparent animate-pulse"
          style={{ animationDelay: "1s" }}
        ></div>
          <div className="absolute top-0 left-0 w-full h-full">
            <div className="absolute top-1/4 left-1/4 w-40 h-40 sm:w-60 sm:h-60 md:w-96 md:h-96 bg-primary/10 rounded-full blur-3xl animate-pulse opacity-30"></div>
            <div
              className="absolute bottom-1/4 right-1/4 w-36 h-36 sm:w-56 sm:h-56 md:w-80 md:h-80 bg-primary/15 rounded-full blur-2xl animate-pulse opacity-20"
              style={{ animationDelay: "1s" }}
            ></div>
                        <div
              className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-28 h-28 sm:w-40 sm:h-40 md:w-64 md:h-64 bg-primary/8 rounded-full blur-xl animate-pulse opacity-25"
      ...
      <div className="relative z-10 space-y-3 md:space-y-5 lg:space-y-6 mb-4 md:mb-7 lg:mb-9 max-w-xs md:max-w-[500px] lg:max-w-[588px] mt-12 md:mt-[120px] lg:mt-[160px] px-2 md:px-4">
        <h1 className="text-foreground text-2xl md:text-4xl lg:text-6xl font-semibold leading-tight">
          Websites for CMS & Businesses
        </h1>
      ...
      <Link href="https://vercel.com/home" target="_blank" rel="noopener noreferrer">
        <Button className="relative z-10 overflow-hidden bg-secondary text-secondary-foreground hover:bg-secondary/90 px-5 sm:px-6 md:px-8 py-2 md:py-3 rounded-full font-medium text-sm md:text-base shadow-lg ring-1 ring-white/10 transition-all duration-300 hover:scale-105 hover:shadow-xl group wave-shine">
          <span className="relative z-10">Book a meeting</span>
          <div className="absolute inset-0 bg-gradient-to-r from-primary/30 via-primary/20 to-primary/30 opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
        </Button>
      </Link>
    </section>
  )
