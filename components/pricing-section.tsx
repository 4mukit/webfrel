...
export function PricingSection() {
  ...
  return (
    <section className="w-full px-5 overflow-hidden flex flex-col justify-start items-center my-0 py-8 md:py-14">
      <div className="self-stretch relative flex flex-col justify-center items-center gap-2 py-0">
        <div className="flex flex-col justify-start items-center gap-4">
          <h2 className="text-center text-foreground text-4xl md:text-5xl font-semibold leading-tight md:leading-[40px]">
            Our Services for every business
          </h2>
      ...
      <div className="self-stretch px-5 flex flex-col md:flex-row justify-start items-stretch md:items-start gap-4 md:gap-6 mt-6 max-w-[1100px] mx-auto">
        {pricingPlans.map((plan) => (
          <div
            key={plan.name}
            className={`flex-1 p-4 overflow-hidden rounded-xl flex flex-col justify-start items-start gap-6 transition-all duration-500 hover:scale-105 hover:shadow-2xl group ${plan.popular ? "bg-primary shadow-[0px_4px_8px_-2px_rgba(0,0,0,0.10)] hover:shadow-primary/20" : "bg-gradient-to-b from-gray-50/5 to-gray-50/0 hover:from-primary/5 hover:to-primary/10"}`}
          ...
          >
            <div className="self-stretch flex flex-col justify-start items-start gap-6">
              ...
              <Button
                className={`self-stretch px-5 py-2 rounded-[40px] flex justify-center items-center transition-all duration-300 hover:scale-105 hover:shadow-lg group ${plan.buttonClass}`}
              >
