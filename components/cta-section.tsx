...
export function CTASection() {
  return (
    <section className="w-full pt-16 sm:pt-24 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
      ...
      <div className="relative z-10 flex flex-col justify-start items-center gap-6 sm:gap-8 md:gap-9 max-w-4xl mx-auto">
        <div className="flex flex-col justify-start items-center gap-4 text-center">
          <h2 className="text-foreground text-3xl sm:text-4xl md:text-5xl lg:text-[68px] font-semibold leading-tight md:leading-tight lg:leading-[76px] break-words max-w-[435px]">
        ...
        <Link href="https://vercel.com/home" target="_blank" rel="noopener noreferrer">
          <Button
            className="relative overflow-hidden px-[30px] py-2 bg-secondary text-secondary-foreground text-base font-medium leading-6 rounded-[99px] shadow-[0px_0px_0px_4px_rgba(255,255,255,0.13)] hover:bg-secondary/90 transition-all duration-300 hover:scale-105 hover:shadow-xl group wave-shine"
            size="lg"
          >
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-primary/20 via-transparent to-primary/20 opacity-0 group-hover:opacity-100 blur-sm transition-all duration-700"></div>
          </Button>
        </Link>
      </div>
    </section>
